...
<head>
    ...
    <title>Acceso Entrenadores | Sistema Gimnasio</title>
                ...
                <div class="login-container">
                    <div class="card login-card">
                        <div class="login-header">
                            ...
                            <p class="mb-0 opacity-75">Área de Entrenadores</p>
                        </div>
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form method="POST" action="{{ route('trainer.login') }}">
                                ...
                                <div class="text-center">
                                    <p class="mb-0">¿Problemas para acceder? <a href="#" class="text-decoration-none">Contactar administración</a></p>
                                </div>
                            </form>
                        </div>
                    </div>

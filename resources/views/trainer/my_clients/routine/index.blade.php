...
@section('content')
    ...
    @endif
    {{-- AÑADIDO: Bloque para mostrar errores de validación del modal --}}
    @if ($errors->any())
        ...
        <div class="col-md-5">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h5 class="mb-0">
                        {{ $asignacionActiva ? 'Asignar una Nueva Rutina (reemplazará la actual)' : 'Crear Nueva Rutina para el Cliente' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('trainer.clients.routine.store', $cliente->id_cliente) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre_rutina" name="nombre_rutina"
                                placeholder="Ej: Semana 1 - Acondicionamiento" required>
                        </div>
        ...
        <div class="col-md-7">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if ($asignacionActiva)
                        {{-- ===== MODIFICACIÓN DEL BOTÓN PARA ABRIR EL MODAL ===== --}}
                        ...
                        @forelse ($asignacionActiva->rutina->rutinaEjercicios as $rutinaEjercicio)
                            <div class="p-2 border-bottom">
                                ...
                                <p class="mb-1 text-muted">
                                    {{ $rutinaEjercicio->series }} series x {{ $rutinaEjercicio->repeticiones }} repeticiones |
                                    Descanso: {{ $rutinaEjercicio->descanso_segundos }}s
                                </p>
                            </div>
                        @empty
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addExerciseModalLabel">Añadir Ejercicio a la Rutina:
                            {{ $asignacionActiva->rutina->nombre }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{ route('trainer.clients.routine.add_exercise', $asignacionActiva->rutina->id_rutina) }}"
                        method="POST">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="series" id="series" placeholder="Ej: 4"
                                        required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="repeticiones" class="form-label">Repeticiones</label>
                                    <input type="text" class="form-control" name="repeticiones" id="repeticiones"
                                        placeholder="Ej: 8-10" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="duracion_segundos" id="duracion_segundos"
                                        placeholder="Ej: 60">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="descanso_segundos" class="form-label">Descanso (segundos)</label>
                                    <input type="number" class="form-control" name="descanso_segundos" id="descanso_segundos"
                                        placeholder="Ej: 90">
                                </div>
                            </div>

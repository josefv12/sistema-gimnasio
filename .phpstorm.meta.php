...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.trainer.driver' => 'string',
            'auth.guards.trainer.provider' => 'string',
            ...
            'auth.providers.administradores.driver' => 'string',
            'auth.providers.administradores.model' => 'string',
            'auth.providers.entrenadores.driver' => 'string',
            'auth.providers.entrenadores.model' => 'string',
            'auth.providers.clientes.driver' => 'string',
            'auth.providers.clientes.model' => 'string',
            ...
            'auth.passwords.clientes.provider' => 'string',
            'auth.passwords.clientes.table' => 'string',
            'auth.passwords.clientes.expire' => 'integer',
            'auth.passwords.clientes.throttle' => 'integer',
            'auth.passwords.administradores.provider' => 'string',
            'auth.passwords.administradores.table' => 'string',
            'auth.passwords.administradores.expire' => 'integer',
            'auth.passwords.administradores.throttle' => 'integer',
            'auth.passwords.entrenadores.provider' => 'string',
            'auth.passwords.entrenadores.table' => 'string',
            'auth.passwords.entrenadores.expire' => 'integer',
            'auth.passwords.entrenadores.throttle' => 'integer',
            ...
            'filesystems.links.C:\xampp\htdocs\sistema-gimnasio\public\storage' => 'string',
            ...
            'permission.models.administrador' => 'string',
            'permission.models.entrenador' => 'string',
            'permission.models.cliente' => 'string',
...
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.trainer.driver','auth.guards.trainer.provider','auth.guards.sanctum.driver',
'auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.administradores.driver','auth.providers.administradores.model',
'auth.providers.entrenadores.driver','auth.providers.entrenadores.model','auth.providers.clientes.driver','auth.providers.clientes.model','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.clientes.provider','auth.passwords.clientes.table',
'auth.passwords.clientes.expire','auth.passwords.clientes.throttle','auth.passwords.administradores.provider','auth.passwords.administradores.table','auth.passwords.administradores.expire',
'auth.passwords.administradores.throttle','auth.passwords.entrenadores.provider','auth.passwords.entrenadores.table','auth.passwords.entrenadores.expire','auth.passwords.entrenadores.throttle',
...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\sistema-gimnasio\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'permission.models.role','permission.models.administrador','permission.models.entrenador','permission.models.cliente','permission.table_names.roles',
...
'web','api',);
        registerArgumentsSet('routes', 'admin.login','admin.','admin.logout',
'storage.local',);
